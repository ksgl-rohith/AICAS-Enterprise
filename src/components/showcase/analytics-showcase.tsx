      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-bold text-slate-500">Total Impressions</span>
            <div className="w-8 h-8 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600">
              <TrendingUp className="w-4 h-4" />
            </div>
          </div>
          <div className="text-3xl font-extrabold text-slate-900">412,850</div>
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-bold text-slate-500">Avg Click-Through Rate</span>
          ...
          <div className="text-3xl font-extrabold text-slate-900">4.82%</div>
          <div className="text-xs text-emerald-600 font-bold mt-2 flex items-center gap-1">
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-md">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-bold text-slate-500">Campaign ROI Attribution</span>
            <div className="w-8 h-8 rounded-xl bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600">
              <DollarSign className="w-4 h-4" />
            </div>
          </div>
          <div className="text-3xl font-extrabold text-emerald-600">384%</div>
      ...
      <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between pb-6 border-b border-slate-200 gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Normalized metrics across LinkedIn, Facebook Pages, Instagram Business, and Telegram Bot APIs</p>
          </div>
          <span className="px-3 py-1 rounded-full text-xs font-mono bg-indigo-50 text-indigo-700 border border-indigo-200 font-bold self-start md:self-auto">
        ...
        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
          <div className="h-64 w-full flex items-end justify-between gap-2 sm:gap-4 relative pt-8 pb-2">
            {/* Grid Line Markers */}
            <div className="absolute inset-0 flex flex-col justify-between pointer-events-none text-[10px] font-mono text-slate-400 border-b border-slate-200 pb-2">
              <div className="border-b border-slate-200/80 w-full flex justify-between pr-2"><span>50,000</span></div>
              <div className="border-b border-slate-200/80 w-full flex justify-between pr-2"><span>37,500</span></div>
              <div className="border-b border-slate-200/80 w-full flex justify-between pr-2"><span>25,000</span></div>
              <div className="border-b border-slate-200/80 w-full flex justify-between pr-2"><span>12,500</span></div>
            ...
            {chartData.map((bar, i) => (
              <div key={i} className="flex-1 flex flex-col items-center h-full justify-end z-10 group cursor-pointer">
                ...
                <div className="text-[11px] font-mono font-extrabold text-indigo-900 bg-white px-2 py-0.5 rounded border border-indigo-200 shadow-xs mb-2 transition-transform group-hover:scale-110">
                  {bar.reach}
                </div>

                {/* Track and Animated Bar Fill */}
                <div className="w-full max-w-[48px] h-48 bg-slate-200/60 rounded-t-xl overflow-hidden flex items-end p-0.5">
                  <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2 text-xs">
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
            <span className="text-slate-500 font-medium block mb-1">Audience Sentiment</span>
            <div className="flex items-center gap-3">
              <span className="text-2xl font-extrabold text-emerald-600">84%</span>
              <span className="text-[11px] text-slate-800 font-bold">Positive / Enthusiastic</span>
            </div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
            <span className="text-slate-500 font-medium block mb-1">Neutral Sentiment</span>
            <div className="flex items-center gap-3">
              <span className="text-2xl font-extrabold text-slate-800">12%</span>
              <span className="text-[11px] text-slate-700 font-semibold">Informational Inquiries</span>
            </div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
            <span className="text-slate-500 font-medium block mb-1">Negative / Risk Flags</span>
            <div className="flex items-center gap-3">
              <span className="text-2xl font-extrabold text-amber-600">4%</span>
              <span className="text-[11px] text-slate-700 font-semibold">Flagged by Community Inbox</span>
            </div>
          </div>
        </div>
      </div>
